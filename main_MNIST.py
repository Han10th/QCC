...
def train_net(Estimator,
              Classifier,
              args):  
    pathname = '../scratch/Mnist_data/'###############NEED TO BE REVISED ACCORDINGLY###########
    ...
    trainset = datasets.MNIST(root=pathname, train=True,download=True, transform=transform)###############NEED TO BE REVISED ACCORDINGLY###########
    testset = datasets.MNIST(root=pathname, train=False, download=True, transform=transform)###############NEED TO BE REVISED ACCORDINGLY###########
...
if __name__ == '__main__':
    ...
    Estimator = EstimateCNN(n_input = 1, n_output = 2, depth_down = args.depth_down, depth_hidden = args.depth_hidden)
    Classifier = ClassifierMINI(n_input = 1, n_output = 10, size = size)###############NEED TO BE REVISED ACCORDINGLY###########
    if args.unload:
